...
public class ActivityLoaderActivity extends Activity {
	...
	static private final String ACTION_EXPLICIT_ACTIVITY = "android.intent.action.EXPLICIT";
...
//		Intent explicitIntent = new Intent(ACTION_EXPLICIT_ACTIVITY);
	...
	private void startImplicitActivation() {
		...
		Intent chooserIntent = Intent.createChooser(baseIntent, "Choose which application");
